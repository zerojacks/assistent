...
from qfluentwidgets import (TextWrap,FluentStyleSheet, themeColor, FluentIconBase,Theme, isDarkTheme, 
                            writeSvg, drawSvgIcon, drawIcon,TransparentToolButton,InfoBarIcon,InfoBarPosition)
...
class CustomInfoBar(QFrame):
    ...
    def __initWidget(self):
        ...
        self.__setQss()
        self.__initLayout()
        self.rotateTimer.setInterval(2000)
        self.closeButton.clicked.connect(self.close)
        self.rotateTimer.timeout.connect(self.close)
