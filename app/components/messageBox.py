from PyQt5.QtWidgets import QApplication, QDialog, QVBoxLayout, QTextEdit, QIcon, QWidget,QHBoxLayout,QFrame,QGraphicsDropShadowEffect,QGraphicsOpacityEffect
